...
L<Term::Shell> and L<Term::TUI>.  I haven't really checked these out.  I did
poke around to see if they were (as RouterCLI calls it) “Stanford style” NLP
parsers, but that's about it.
